...
function CheckCircleRectIntersect(puckPositionX: number, puckPositionY: number, puckRadius: number, bucketPositionX: number, bucketPositionY: number, bucketWidth: number, bucketHeight: number) {
